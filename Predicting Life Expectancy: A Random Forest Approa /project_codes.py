# Predicting Life Expectancy: A Random Forest Approach
...
git clone <repo-url>
cd <repo-folder>
git rm "e_20x20/Predicting Life Expectancy: A Random Forest Approa"
git commit -m "Remove conflicting file to create folder"
git push
